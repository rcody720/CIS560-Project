...
namespace CIS560Project.DataDelegates
{
    internal class RetrieveMoviesDataDelegate : DataReaderDelegate<IReadOnlyList<Movie>>
    {
        ...
        public override IReadOnlyList<Movie> Translate(SqlCommand command, IDataRowReader reader)
        {
            ...
            while (reader.Read())
            {
                movies.Add(new Movie(reader.GetInt32("MovieId"), reader.GetString("MovieName"), reader.GetString("Rating"), reader.GetInt32("RunTime"), reader.GetDateTime("ReleaseDate")));
            }
